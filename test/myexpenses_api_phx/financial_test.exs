defmodule MyexpensesApiPhx.FinancialTest do
  ...
  describe "expenses" do
    ...
    @valid_attrs %{confirmed: true, date: ~D[2010-04-17], installmentNumber: "some installmentNumber", installmentUUID: "some installmentUUID", name: "some name", value: 42}
    @update_attrs %{confirmed: false, date: ~D[2011-05-18], installmentNumber: "some updated installmentNumber", installmentUUID: "some updated installmentUUID", name: "some updated name", value: 43}
